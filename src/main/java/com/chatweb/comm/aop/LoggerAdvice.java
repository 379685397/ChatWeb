...
public class LoggerAdvice {
    ...
    @Before("within(com.chatweb..*) && @annotation(loggerManage)")
    ...
    @AfterReturning("within(com.chatweb..*) && @annotation(loggerManage)")
    public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
        logger.info("执行 " + loggerManage.description() + " 结束");
    }

    @AfterThrowing(pointcut = "within(com.chatweb..*) && @annotation(loggerManage)", throwing = "ex")
